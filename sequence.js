...
return {
    _seq: [
...

        {
            ...
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.589, 0.67, 0.6],
            // how this varies by vertical 
            u_ocean_hsl_variation: [0., 0.9, 0.2],
            // base color of aura (hue, sat, lightness in 0..1)
            u_aura_hsl: [0.512, 0.8, 0.8],
            // how this varies by aura intensity:
...

		{
            ...
            _time: 120, // 3 min, B to Chanllenge
        ...
        },
        {
            ...
            // colors:
            u_creatures_hsl: [0.08, 0.6, 0.5],
            u_creatures_hsl_inside: [0.167, 0.5, 0.6],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.59, 0.5, 0.5],
            // how this varies by vertical 
            u_ocean_hsl_variation: [0., 0.3, 0.2],
            // base color of aura (hue, sat, lightness in 0..1)
            u_aura_hsl: [0.4, 0.8, 0.8],
            // how this varies by aura intensity:
            u_aura_hsl_variation: [0.1, 0., 0.],
        ...
        },
        {
            ...
            // colors:
            u_creatures_hsl: [0.4333, 0.7, 0.7],
            u_creatures_hsl_inside: [0.5111, 0.6, 0.6],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.6, 0.5, 0.6],
            // how this varies by vertical 
        ...
        },
        {
            ...
            u_creatures_hsl_inside: [0.333, 0.5, 0.5],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.6, 0.5, 0.6],
            // how this varies by vertical 
            u_ocean_hsl_variation: [0., 0.5, 0.2],
