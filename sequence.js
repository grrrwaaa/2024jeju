...
return {
    _seq: [
...

        {
            ...
            // colors:
            u_creatures_hsl: [0.6, 0.5, 0.3],
            u_creatures_hsl_inside: [0.677, 0.6, 0.5],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.6, 0.5, 0.55],
            // how this varies by vertical 
            u_ocean_hsl_variation: [0., 0.5, 0.2],
        ...
        },
        {
            ...
            // colors:
            u_creatures_hsl: [0.6667, 0.6777, 0.5],
            u_creatures_hsl_inside: [0.8333, 0.7, 0.6],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.6, 0.5, 0.55],
            // how this varies by vertical 
            u_ocean_hsl_variation: [0., 0.5, 0.2],
        ...
        },
        {
            ...
            u_creatures_hsl_inside: [0.6667, 0.788, 0.5],
            // base color of ocean (hue, sat, lightness in 0..1)
        ...
        },
        {
            ...
            // colors:
            u_creatures_hsl: [0.833, 0.8, 0.6777],
        ...
        },
        {
            ...
            // colors:
            u_creatures_hsl: [0.6667, 0.55, 0.4],
            u_creatures_hsl_inside: [0.333, 0.88, 0.5],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.6, 0.5, 0.6],
            // how this varies by vertical 
        ...
        },
        {
            ...
            u_creatures_hsl_inside: [0.334, 0.8, 0.9],
            // base color of ocean (hue, sat, lightness in 0..1)
            u_ocean_hsl: [0.6, 0.5, 0.6],
            // how this varies by vertical 
